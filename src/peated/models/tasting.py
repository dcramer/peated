...
class Tasting(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(["bottle_id"], ["bottle.id"], name="tasting_bottle_id_bottle_id_fk"),
        ForeignKeyConstraint(["created_by_id"], ["user.id"], name="tasting_created_by_id_user_id_fk"),
