...
- [x] 6.5 Close the optional SMWS alias seed as a separate catalog operation.
      The feature shipped without guessing aliases; any future seed still
      requires bounded evidence and moderator-owned operations.
