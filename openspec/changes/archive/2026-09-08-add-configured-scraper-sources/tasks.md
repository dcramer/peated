...
- [x] 7.4 Pilot one review source and one simple price source. Later saved-rule
      cutovers activated and production-verified review and price sources before
      their code-owned registrations were retired.
