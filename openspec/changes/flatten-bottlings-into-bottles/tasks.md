...
- [ ] 5.5b In the approved price-match transaction, resolve one CatalogTarget and atomically use it for the listing-alias assignment and observation write while preserving the existing price-assignment semantics; leave proposal decision vocabulary to task 5.7.
