...
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `reference.id` (removed)             | NONE. The runtime still owns it for tracing.                                                                                                          | The model could read a source id as a Peated `bottleId`/`matchedBottleId` and echo it into a decision.                                                                                          | **REMOVED** — the internal correlation id no longer reaches the agent.                                                                                         |
| `reference.externalSiteId` (removed) | NONE. The runtime still owns it for tracing.                                                                                                          | The model could read an internal site id as a Peated Entity or Bottle id.                                                                                                                       | **REMOVED** — the internal site correlation id no longer reaches the agent.                                                                                    |
...
| `score` (`:218`)                                                                                                                                                  | Runtime-only retrieval ordering.                                                                                                              | Model may rank by `score` despite the spec forbidding rank-driven matches.                                                                                                 | **REMOVED from agent evidence; retained in runtime candidates.**                                                             |
| `source` (`:219`)                                                                                                                                                 | Runtime-only provenance that feeds `hasExactAliasMatch`.                                                                                      | Opaque provenance strings ("exact", search source); model may over-trust.                                                                                                  | **REMOVED from agent evidence; retained in runtime candidates.**                                                             |
