...
| Whisky Advocate    | `https://whiskyadvocate.com`               | GET issue index, then one GET review listing per unprocessed issue; cursor stores completed issues | 106 issues and 166 reviews in parser fixtures                       |
