...
## Springbank, Longrow, and Hazelburn — September 6, 2026

The production review started with 268 Brand-attached Bottles: 197 Springbank,
46 Longrow, and 25 Hazelburn. It finished with 320: 197 Springbank, 82 Longrow,
and 41 Hazelburn. The operation created 52 exact release records, corrected 17
existing records, created four Series, and attached three licensed Bottle
images. It did not merge or delete records.

- The producer's [Springbank range](https://www.springbank.scot/whisky/springbank-range/),
  [Longrow range](https://www.springbank.scot/whisky/longrow/), and
  [Hazelburn range](https://www.springbank.scot/whisky/hazelburn/) established
  the current core releases, 2026 annual releases, maturation, strength, and
  outturn where published. The separate
  [Hazelburn Sherry Wood 2025 page](https://www.springbank.scot/whisky/hazelburn/sherry-wood-8yo-2025/)
  established that edition. The
  [Countdown introduction](https://www.springbank.scot/countdown-collection/countdown-collection-an-introduction/)
  established five annual 500-bottle releases; the four releases available by
  the review date were updated with that outturn.
- [Whisky Auctioneer's Springbank list](https://whiskyauctioneer.com/learn/explore-whisky/distilleries/springbank),
  [Longrow list](https://whiskyauctioneer.com/learn/explore-whisky/brands/longrow),
  and [Hazelburn list](https://whiskyauctioneer.com/learn/explore-whisky/brands/hazelburn)
  were historical gap finders. Its
  [Longrow Red guide](https://whiskyauctioneer.com/learn/explore-whisky/series/longrow-red),
  [Longrow Open Day guide](https://whiskyauctioneer.com/learn/explore-whisky/series/longrow-springbank-open-day-bottlings),
  and [Hazelburn Open Day guide](https://whiskyauctioneer.com/learn/explore-whisky/series/hazelburn-springbank-open-day-bottlings)
  supplied bounded release families. Exact auction lots, readable labels, and
  specialist timelines were used when those guides omitted a year, strength,
  vintage, or outturn.
- Production Series `S0656`–`S0659` now hold Longrow Open Day (12 releases),
  Longrow Red (12), Hazelburn Sherry Wood (8), and Hazelburn Open Day (9).
  Newly created Bottles are `B53881`–`B53932`. The known annual Longrow 18 and
  21 releases, 2025–2026 100° Proof releases, Hazelburn's three 2005 first-edition
  labels, and the 2022–2023 Hazelburn 21 releases were also added.
- Existing Hazelburn Sherry Wood and Open Day records had wrong or missing ages,
  years, strengths, outturns, Series, or Springbank distillery relationships.
  These were corrected only where an exact label or page supported the value.
  The generic Hazelburn 2004 Oloroso record remains unchanged because it could
  mean either the 13-year 2018 edition or the 14-year 2019 edition.
- The Longrow Red Tawny Port record keeps bottling year 2022 but no release year
  because sources disagree about whether to call it a 2022 or 2023 release. The
  current Longrow 100° Proof page also gives conflicting red-wine cask details,
  so no maturation value was stored for the 2026 edition.
- The [Wikimedia Springbank bottle category](https://commons.wikimedia.org/wiki/Category:Springbank_bottles)
  contained four exact Bottle photos with verified reuse terms. Three were a
  safe identity match and were stored with their source page and `CC BY-SA 3.0`
  license: Springbank 15 (`B0872`), Longrow 10-year-old 100 Proof (`B1104`),
  and Hazelburn 8 First Edition – The Stills (`B53930`). Producer, retailer, and
  auction photos without stated reuse permission were not copied.
- No public source proved a complete list of every Society, duty-paid sample,
  cage, hand-fill, retailer, country, or private-cask release. Those families
...
## Jack Daniel's — September 6, 2026

The production review started with 48 Brand-attached Bottles and finished with 155. It created 107 exact Bottle records and ten Series, corrected the distillery
or bottler relationship on 34 pre-existing Bottles, assigned 20 pre-existing
releases to documented Series, and assigned 39 exact or safely normalized Bottle
References. It did not merge or delete records. The complete create manifest,
including the exact evidence page and stored facts for every new Bottle, is in
[Jack Daniel's catalog evidence](./jack-daniels-catalog-evidence-2026-09.json).

- The producer's [sitemap](https://www.jackdaniels.com/sitemap.xml),
  [current product pages](https://www.jackdaniels.com/whiskey), and
  [press-room product list](https://pressroom.jackdaniels.com/products/) exposed
  both current releases and preserved pages for historical decanters,
  commemorative bottles, Gold Medal releases, Holiday Select, Before & After,
  the saloon bottles, and other discontinued releases. The default English
  pages were used; duplicated localized paths were not treated as separate
  Bottles.
- Official announcements established the Aged Series: the
  [2021 10-year launch](https://pressroom.jackdaniels.com/jack-daniels-launches-first-age-stated-whiskey-in-over-100-years/),
  [2023 10- and 12-year release](https://pressroom.jackdaniels.com/jack-daniels-introduces-new-12-year-old-tennessee-whiskey-in-its-annual-aged-series-release/),
  [2024 batches](https://pressroom.jackdaniels.com/jack-daniels-launches-new-batches-of-12-year-old-and-10-year-old-tennessee-whiskey/),
  and [2025 10-, 12-, and 14-year release](https://pressroom.jackdaniels.com/jack-daniels-introduces-14-year-old-tennessee-whiskey-for-the-first-time-in-over-a-century/).
  The producer's current [14-year page](https://www.jackdaniels.com/whiskey/14-year-old-tennessee-whiskey)
  and a syndicated [2026 release announcement](https://www.breakingbourbon.com/bourbon-whiskey-press-releases/jack-daniels-introduces-new-batches-of-award-winning-aged-series-tennessee-whiskeys)
  established the 2026 batches. Series `S0688` contains 11 exact releases,
  including the pre-existing 2026 10-year Batch 5.
- The collector's [complete Bottle index](https://jackdanielsbottles.com/bottles/)
  and [Series index](https://jackdanielsbottles.com/series/) supplied a bounded
  chronology for releases that the current producer site omits. Exact child
  pages supplied the release year and marketed name. This completed the renamed
  Tennessee Tasters/Distillery Series selections 1–17 (`S0685`, 17 records),
  Scenes from Lynchburg bottles 1–12 (`S0689`), and the annual
  [Ducks Unlimited releases](https://jackdanielsbottles.com/bottle/ducks-unlimited-series/)
  from 2006 through 2017 (`S0701`). The separate
  [Eric Church Single Barrel page](https://jackdanielsbottles.com/bottle/eric-church-single-barrel/)
  established the 2020 94-proof release, now `B54392`.
- A second exact-name and Series reconciliation corrected 23 pre-existing
  records. It restored Distillery Series #16 (`B43936`) to Tennessee rye with
  its 2025 date and 111.4 proof, restored the word `Straight` to selections
  8–12 where marketed, normalized 10-year Batch 5 (`B46425`), completed the
  producer-defined Bonded (`S0348`, three records), Legacy (`S0122`, three
  records), and Single Barrel (`S0019`, seven records) ranges, and left the
  conflicting 91/92-proof Barrel Reunion #2 value unknown.
- Exact collector pages also established six previously absent marketed
  releases: Gentleman Jack Commemorative Bottle (`B54450`), Gentleman Jack
  Timepiece (`B54453`), the Paula Scher Label (`B54454`), and the Japan, UK,
  and Singapore Master Distiller Bottles (`B54455`–`B54457`). The three
  country releases belong to the separately documented International Master
  Distiller Bottles Series `S0709`.
- Official pages and announcements established the 2022 American Single Malt,
  2023 travel-retail American Single Malt, 2023–2025 McLaren labels,
  [2026 Halo MK1](https://pressroom.jackdaniels.com/jack-daniels-debuts-design-forward-halo-mk1-tennessee-whiskey-with-mclaren-mastercard-formula-1-team/),
  and the permanent
  [2025 Single Barrel Heritage Barrel](https://pressroom.jackdaniels.com/jack-daniels-single-barrel-heritage-barrel-tennessee-whiskey-launches-as-permanent-expression/).
  Whisky Auctioneer's [Jack Daniel's Brand guide](https://whiskyauctioneer.com/learn/explore-whisky/brands/jack-daniels)
  and exact Bottle pages were used as independent checks and for the Old No. 7
  Green Label and 2026 Boiler Hill #2 leads.
- Production Series created in this review are `S0685` Distillery Series,
  `S0686` Holiday Select, `S0687` Gold Medal Series, `S0688` Aged Series,
  `S0689` Scenes from Lynchburg, `S0690` Saloon Bottles, `S0691` Before &
  After, `S0692` Single Barrel Special Release, `S0701` Ducks Unlimited, and
  `S0709` International Master Distiller Bottles. Final verification fetched
  both Brand inventory pages: all 155 Bottles have
  Brand `E1079`, distiller `E366689`, and no explicit bottler.
- The Bottle Reference search returned 116 strings. Ninety-nine are assigned
  after this review. The 17 left unresolved are batchless aged releases,
  multi-Bottle sets and a calendar, retailer-pick names without enough cask
  identity, undated Holiday Select, Legacy, McLaren, or Twice Barreled names, a
  non-whisky bitters product, and a Sinatra Select string with two possible
  production targets. These were not guessed or ignored.
- Generic pre-existing records `B12899`, `B24679`, and `B15896` may overlap
  exact Aged or 150th Anniversary releases, and `B16740` and `B44146` may be
  duplicate Sinatra Select records. No merge was made because the generic
  records do not identify a single exact release or separate approval would be
  required.
- Twenty-six Bottle records had an existing image and 129 did not. No existing
  image records both a source page and license. Producer, collector,
...
Brand (`E0493`). Five already had images and 102 did not. The review added two
exact, reusable photos, bringing coverage to 7 of 107 Bottles. No Bottle facts,
relationships, or existing images were changed.

- The [Yamazaki Bottle category on Wikimedia Commons](https://commons.wikimedia.org/wiki/Category:Yamazaki_bottles)
  contained reusable photos of the no-age-statement Yamazaki and the 10-, 12-,
  and 18-year-old releases. The age-stated records already had useful images.
  The exact [Japanese no-age-statement photo](<https://commons.wikimedia.org/wiki/File:Yamazaki_NA_180ml_(cropped).jpg>)
  was stored on `B51688` with its `CC BY-SA 4.0` terms and creator credit. The
  producer's [Japanese lineup](https://www.suntory.co.jp/whisky/yamazaki/product/)
  independently confirmed the 43% regular and 180 ml versions as the same
  marketed whisky, so package size did not create a separate Bottle.
- An [Openverse search for Yamazaki whisky](https://openverse.org/search/image?q=yamazaki%20whisky)
  led to a clear [Flickr photo of Yamazaki Limited Edition 2014](https://www.flickr.com/photos/23203692@N03/16355966287).
  The label exactly matched `B0970`; the photo was stored with its `CC BY 2.0`
  terms and creator credit.
- Licensed Flickr results for Sherry Cask did not prove which annual release
  they showed. A [2012 tasting-lineup photo](https://www.flickr.com/photos/7533117@N07/15122749206)
  identified Sherry Cask 2012 and Bourbon Barrel 2012, but each Bottle occupied
  too little of the multi-Bottle image for a useful catalog photo. Those records
  were left unchanged rather than guessing a year or storing a poor crop.
- Bar, distillery-library, shelf, auction, retailer, and producer images were
  useful identity leads but were not copied when they lacked reusable terms or
  did not isolate one exact marketed Bottle. Search result thumbnails and direct
  image URLs were not treated as source or license evidence.

## Yamazaki — September 6, 2026

The full production review is in progress. It started from 107 Bottles attached
to the Yamazaki Brand (`E0493`) and currently has 164. The modern producer range,
...
inventoried. Production now reports 224 Yamazaki-distilled records. Older private
...
- The producer's [Japanese product range](https://www.suntory.co.jp/whisky/yamazaki/product/)
  ...
  [12-year-old anniversary page](https://house.suntory.com/yamazaki-whisky/yamazaki-12-years-100-anniversary-edition)
  identifies that bottle as a limited label design, so it remains the same
  marketed release rather than a second Bottle.
- The [100th Anniversary Mizunara 18-year-old page](https://house.suntory.com/yamazaki-whisky/yamazaki-mizunara-18-years-100-anniversary-edition)
  and an [exact Bonhams lot](https://www.bonhams.com/auction/30245/lot/511/yamazaki-18-years-old-100th-anniversary-mizunara-cask-1-700ml-bottle/)
  established the distinct 2023, 48% release now stored as `B54094` in Series
  `S0073`. Suntory's
...
- The exact
  [1984 25th Anniversary record](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1984-25th-anniversary)
  established the marketed anniversary descriptor and Mizunara maturation now
  stored on `B17672`. The exact
  [80th Anniversary record](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-suntory-pure-malt-80th-anniversary-1)
  established “Suntory Pure Malt” as the stable product name and “80th
  Anniversary” as the edition on singleton `B51629`. Both records and the
  renamed Bottle's edit context, aliases, and references were re-fetched after
  the updates.
- A Bonhams catalog entry for the
  [1984 Waku Waku release](https://images1.bonhams.com/original?src=Images%2Flive%2F2022-10%2F21%2FS-27735-0-1.pdf)
  established its 20-year age, 2004 bottling and release, 56% ABV, and 20th
  Anniversary descriptor. It is now `B54356`. The same catalog and exact
  Whisky Auctioneer pages established six 1984-vintage, 2018
  [Suntory Single Cask Whisky](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1984-suntory-single-cask)
...
- Five more exact Whisky Auctioneer records established the 1990 sherry-butt
  ...
  (`B54387`), its sibling
  [`OM70174`](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1990-single-cask-om70174)
  (`B54393`), the 1992 cask
  [`ZL3001`](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1992-single-cask-zl3001)
  (`B54384`), the 1995 Whisky Magazine sherry-butt cask
  [`5X70170`](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1995-single-cask-5x70170-whisky-magazine)
  (`B54385`), and the 1999 Grand Arc Hanzomon hogshead
  [`DV70305`](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1999-single-cask-dv70305-grand-arc-hanzomon)
...
- An exact
  [Whisky Auctioneer record](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-12-year-old-watami-president-choice),
  a [Bonhams catalog](https://images1.bonhams.com/original?src=Images%2Flive%2F2023-10%2F16%2FS-28697-0-2.pdf),
  and a [contemporary review](https://nonjatta.blogspot.com/2008/03/yamazaki-12-watami-president-choice.html)
  establish the separate 43%, sherry-cask 12-year-old – Watami President Choice
  (`B54476`). Exact Spink, Acker, and
  [Whisky Hammer](https://www.whiskyhammer.com/item/209340/Yamazaki/Yamazaki---1996-Single-Cask-AX70053.html)
  records establish the 1996-vintage, 2008-bottled, 62% sherry-butt The Single
  Cask `AX70053` (`B54477`), with an outturn of 432. A retailer's conflicting
  61% transcription was not used. The exact
  [Whisky Auctioneer Whisky Voice record](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1993-whisky-voice)
  and a [detailed contemporary release record](https://sakedori.com/s/6ichlw5ytz/blog/4936.html)
  establish the 1993-vintage, 2003-bottled and released, 61% bourbon-cask Whisky
  Voice `3D3005` (`B54478`), with an outturn of 185. The detailed release record
  and label-level catalog evidence support 61% over Whisky Auctioneer's
  conflicting 62% transcription. All three were duplicate-checked before
  creation. `B54476` was re-fetched; direct re-fetches of `B54477` and `B54478`
  remain pending, although their creation responses contained the expected
...
- The [2022 Tsukuriwake announcement](https://www.prnewswire.com/news-releases/from-the-birthplace-of-japanese-whisky-the-house-of-suntory-introduces-2022-limited-edition-yamazaki-tsukuriwake-selection-301548951.html)
  ...
  2020, four 2022, and three 2024 Yamazaki releases. Its 2024 Mizunara
...
- Exact auction catalogs and release records established seven more members of
  `S0700`: the 1991 sherry butt recorded as `IO70047` on `B54418` from the
  ...
  sources do not establish that these are the complete historical range.
  [Whiskyfun's exact review](https://nonjatta.blogspot.com/2008/08/cask-of-yamazaki-19912002-sherry.html)
  and an independent
...
- The broader Whisky Auctioneer index and independent exact catalogs establish
  eight more non-Owner's Cask releases. The Cask of Yamazaki sherry butt
  ...
  [`3Q70044`](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1993-single-cask-3q70044-heavily-peated),
  [`3Q70045`](https://www.sothebys.com/en/buy/auction/2024/fine-rare-whisky-2/yamazaki-the-cask-of-yamazaki-3q70045-62-0-abv),
  ...
  were distilled in 1993 and bottled at 62%. Cask `3Q70044` is a 14-year-old
  bottled in 2007 with a 554-bottle outturn; `3Q70045`, `3Q70047`, and
  `3Q70048` are 15-year-olds bottled in 2008 with respective outturns of 504,
  473, and 503. A 492-bottle secondary transcription for `3Q70048`
  ...
  All 11 releases in this paragraph are staged for immediate production
...
- The
  ...
  [W. Whisky Shop lot](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1999-single-cask-dr70117-w-whisky-shop-2nd-anniversary)
  and independent Japanese records show `DR70117`, already stored on `B51840`.
  An additional exact
  ...
  `3Q70038` were initially held as leads and are resolved in the closing
  findings below. The Poly catalogs establish puncheon
  [`3F3080`](https://cdn.polyauction.com.hk/public-default/auction/sale/sz16084423-xiang-gang-bao-li-2016qiu-pai-zhong-xi-ming-jiu-zhen-niang-shuang-p_cf42c5b6-9be7-4618-9e80-774f3a22fd62.pdf)
  and Chiyoda Ute 60th Anniversary sherry butt
  [`3X70003`](https://cdn.polyauction.com.hk/public-default/auction/sale/chinese-and-western-wine_261eec0e-9913-4fd2-99cf-134537d9be35.pdf)
  as The Owner's Cask. Whisky Auctioneer shortens the latter's auction title to
  Single Cask, but its exact facts and the independently indexed bottle series
  match the Poly identity. The exact
  [Bonhams S-23354 catalog](https://images3.bonhams.com/original?src=Images%2Flive%2F2016-10%2F24%2FS-23354-0-1.pdf)
  visibly shows The Owner's Cask labels and establishes white-oak hogshead
  ...
  collector-index entries `3N70042`, `3O70320`, and `3P70186` were initially
  held until exact label or auction evidence could settle their stable family
  and facts. `3O70320` and `3P70186` are resolved in the closing findings below;
  `3N70042` remains held because its exact Poly title omits the label family.
  `3P70187`, `3Q70046`, and `3Q70300` were initially held with them and are also
  ...
  442-bottle outturn. `OS70266` and `OS70301` were initially index-only leads
  and are resolved in the closing findings below. `0U70178` and `O065404` have
...
- A cask-by-cask 1995 reconciliation adds 12 more evidence-backed Owner's Casks:
  ...
  are real 1995 releases. `5R70255` remains held because the available exact
  records do not settle its producer-stable Bottle name; `5R70319` is resolved
  in the closing findings below. This raises the staged sets
...
- The 1998 reconciliation adds 15 evidence-backed Owner's Casks: `CM70004`,
  ...
  though auction indexes group it under Owner's Cask. `CU70065` was initially
  held because exact catalogs and label-oriented records disagreed between
  Owner's Cask and Arima/Suntory Single Cask Whisky; a later label check resolves
  it in the closing findings below. `CW70201`, `CW70207`, and
...
- The follow-up image review replaced two unattributed retailer-derived images
  ...
  whose visible label is the 18-year-old, under `CC BY-SA 3.0` with credit to
...
- A final review of exact bottle photographs resolves nine more Owner's Casks.
  The collector's photographed 1993 page establishes 16-year-old
  [`3N70041`](https://yabejojo.jimdoweb.com/yamazaki/yamazaki-vintage-1993/),
  bottled in 2009 at 57% with a 143-bottle outturn. Exact Whiskybase records
  establish 1993 puncheon
  [`3Q70038`](https://www.whiskybase.com/whiskies/whisky/42634/yamazaki-1993),
  Josu Torys Hub Whisky barrel
  [`3O70320`](https://www.whiskybase.com/whiskies/whisky/107260/yamazaki-1993),
  Chiyoda Ute's 60th Anniversary sherry butt
  [`4R70016`](https://www.whiskybase.com/whiskies/whisky/272766/yamazaki-1994),
  1994 hogshead
  [`4S70038`](https://www.whiskybase.com/whiskies/whisky/262260/yamazaki-1994),
  17-year-old 1990 hogshead
  [`OS70266`](https://www.whiskybase.com/whiskies/whisky/54931/yamazaki-1990),
  and 18-year-old 1992 barrel
  [`2U60037`](https://www.whiskybase.com/whiskies/whisky/77076/yamazaki-1992).
  The 1994 collector page and exact record establish TUD barrel
  [`4D3004`](https://www.whiskybase.com/whiskies/whisky/196247/yamazaki-1994),
  while an exact
  [Whisky Auctioneer record](https://whiskyauctioneer.com/learn/explore-whisky/bottles/yamazaki-1995-single-cask-5r70319)
  and a
  [photographed retailer listing](https://hedonism.co.uk/spirits?ajax-facet=1&f%5B0%5D=out_of_stock%3A1&f%5B1%5D=sp-vintage%3A1995&items_per_page=12&order=desc&pg=1&sort=title_2&spirits_more%5B0%5D=sp-vintage%3A1919&spirits_more%5B1%5D=sp-vintage%3A1972&spirits_more%5B2%5D=sp-vintage%3A2005&sr-perpage=12)
  establish 1995 Owner's Cask hogshead `5R70319`. Source-stated unknown fields
  remain unset. Exact public Peated
  searches returned no cask match for any of the nine, taking the staged
  Owner's Cask set from 217 to 226.
- Label text resolves six more releases outside Owner's Cask, even where an
  auction title or database Series field says otherwise. Exact photographed
  records show `Suntory Single Cask Whisky` on Bar 'C Since 2007 barrel
  [`3P70186`](https://www.whiskybase.com/whiskies/whisky/285707/yamazaki-1993),
  Dental Single Cask Club barrel
  [`1V70591`](https://www.whiskybase.com/whiskies/whisky/303970/yamazaki-1991),
  Waga Kitashinchi sherry butt
  [`1S70461`](https://www.whiskybase.com/whiskies/whisky/277374/yamazaki-1991),
  barrel [`IV70707`](https://www.whiskybase.com/whiskies/whisky/278663/yamazaki-1991),
  JFTD 55th Anniversary hogshead
  [`9V70339`](https://www.whiskybase.com/whiskies/whisky/275608/yamazaki-1989),
  and Arima, Izumiya 60th Anniversary sherry butt
  [`CU70065`](https://www.whiskybase.com/whiskies/whisky/55741/yamazaki-1998).
  Exact
  [Whisky.Auction](https://whisky.auction/auctions/lot/3207/yamazaki-1998-arima-izumiya-60th-anniversay),
  [Spink](https://spink.com/lot/SFW22000208), and
  [contemporary review](https://sakedori.com/s/matsuki/blog/5606.html) records
