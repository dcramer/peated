...
| Mixed activity              | `CommunityFeed`                       | Author, action, date, grouped bottles, scores, and review links; covers personal tasting photos, contains catalog bottle images, gives missing images a neutral frame, uses the usual image size in sidebars and on mobile, and keeps library additions compact. |
