...
- Let data provide character through ratings, distributions, counts, and identifiers.
...
Use tabular numerals for aligned numbers. Do not use the display face as body copy.
