...
const BOTTLE_CLASSIFIER_INSTRUCTIONS = [
  ...
  renderBulletLines([
    ...
    "When an existing clean parent bottle already covers the stable family and the source adds age, vintage, release year, batch, edition, or cask details, prefer `create_release` under that parent over `create_bottle` unless evidence shows those traits are stable parent identity.",
