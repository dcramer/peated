...
const BOTTLE_IDENTITY_AND_EVIDENCE_INSTRUCTIONS = [
  ...
  renderBulletLines([
    ...
    "`bottler` is the named, market-facing bottler or release imprint for this product. It may equal the Brand or a producing distillery. Ownership, importer/distributor, and physical packing relationships alone do not establish the role. Leave it null when product-specific evidence does not establish it.",
...
const BOTTLE_CLASSIFIER_INSTRUCTIONS = [
  ...
  renderBulletLines([
    ...
    "`bottler`: named market-facing bottler or release imprint for the product; may equal `brand` or a distillery.",
