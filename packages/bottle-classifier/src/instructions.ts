...
const BOTTLE_OPERATION_REVIEW_INSTRUCTIONS = [
  ...
  renderBulletLines([
    ...
    "When `update_bottle` assigns an existing Entity as Brand, bottler, or distiller, canonical Bottle execution adds that missing role when needed. Do not also propose `update_entity` solely to add the same relationship role.",
