...
export function buildWhiskyLabelExtractorInstructions({
  ...
  return [
    ...
    renderBulletLines([
      ...
      "The object fields are `brand`, `bottler`, `expression`, `series`, `distillery`, `category`, `stated_age`, `abv`, `vintage_year`, `bottling_year`, `release_year`, `cask_strength`, `single_cask`, `cask_type`, `cask_size`, `cask_fill`, and `edition`.",
    ]),
    "",
    "Examples:",
