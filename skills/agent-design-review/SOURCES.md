...
| `docs/architecture/bottle-classifier.md`                                                    | local repo domain    | primary    | 2026-05-04 | high       | Current bottle classifier boundary, action set, invariants, eval surface, and canonical paths         | repository-local policy              | Repo-specific anchor                                 |
