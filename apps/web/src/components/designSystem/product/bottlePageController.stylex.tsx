...
import { BottleOverview } from "../patterns/bottleOverview.stylex";
import { BottlePageHeader } from "../patterns/bottlePageHeader.stylex";
...
export function BottlePageController({
  initialBottle,
}: {
