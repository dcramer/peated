import { DEFAULT_BOTTLE_CREATION_TARGET } from "@peated/server/lib/bottleSchemaRules";
import {
  normalizeBottle,
  normalizeString,
...
import type {
  BottleCreationTargetEnum,
  ProposedBottleSchema,
  ProposedReleaseSchema,
} from "@peated/server/schemas";
import type { z } from "zod";

// This module owns generic bottle/release draft normalization for classifier
// outputs. Price matching keeps a thin compatibility wrapper so the creation
// policy stays defined once and can be reused by future classifier consumers.

type BottleCreationTarget = z.infer<typeof BottleCreationTargetEnum>;
...
export const inferPriceMatchCreationTarget = inferBottleCreationTarget;
...
export const normalizeCreateNewDrafts = normalizeBottleCreationDrafts;
