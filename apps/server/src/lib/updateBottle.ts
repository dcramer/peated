...
function desiredBottleFor({
  ...
  const release = desiredReleaseFields(bottle, exactPatch);
        ...
        candidates: affectedMembers.map((member) => {
          ...
          return {
            ...
            current: {
              ...
              bottlingYear: member.bottlingYear,
            ...
            desired: {
              ...
              bottlingYear: desired.bottlingYear,
