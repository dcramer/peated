import { GtinSchema, type StorePriceInputSchema } from "@peated/server/schemas";
import { z } from "zod";
...
type StorePriceIdentity = Partial<
  Pick<z.infer<typeof StorePriceInputSchema>, "externalProductId" | "barcode">
>;
...
export function getShopifyStorePriceIdentity(
  ...
  const identity: StorePriceIdentity = {};
