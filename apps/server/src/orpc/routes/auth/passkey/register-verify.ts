...
export type PasskeyRegistrationVerifier = typeof verifyPasskeyRegistration;

export function createPasskeyRegisterVerifyProcedure(
  verifyRegistration: PasskeyRegistrationVerifier = verifyPasskeyRegistration,
) {
  return procedure
    .use(authRateLimit)
    .use(requireAuth)
...
export default createPasskeyRegisterVerifyProcedure();
