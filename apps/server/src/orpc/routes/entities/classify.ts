...
export type EntityClassifier = typeof classifyEntityWithAgent;

export function createEntityClassifyProcedure(
  classify: EntityClassifier = classifyEntityWithAgent,
) {
  return procedure
    .use(requireMod)
    .route({
...
export default createEntityClassifyProcedure();
