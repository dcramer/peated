...
registry.add("IndexBottleSearch", indexBottleSearch);
registry.add("IndexBottleSeriesSearch", indexBottleSeriesSearch);
registry.add("IndexEntitySearch", indexEntitySearch);
