...
class Bottle(Base):
    ...
    bottler = relationship("Entity", foreign_keys=[bottler_id])
    brand = relationship("Entity", foreign_keys=[brand_id])
    created_by = relationship("User")
    distiller = relationship("Entity", secondary="bottle_distiller")
    bottle_tag = relationship("BottleTag")
