...
class StorePrice(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(["bottle_id"], ["bottle.id"], name="store_price_bottle_id_bottle_id_fk"),
        ForeignKeyConstraint(["store_id"], ["store.id"], name="store_price_store_id_store_id_fk"),
