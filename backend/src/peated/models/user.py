...
class User(Base):
    ...
    follow = relationship(
        "Follow", foreign_keys="[Follow.from_user_id]", back_populates="from_user"
    )
    follow_ = relationship(
        "Follow", foreign_keys="[Follow.to_user_id]", back_populates="to_user"
    )
    ...
    notifications_ = relationship(
        "Notifications", foreign_keys="[Notifications.user_id]", back_populates="user"
    )
